...
function buildPublicAccessRoutes({ accessController }) {
  ...
  router.get('/apply/:token', asyncHandler(accessController.showRequestProfileApplication));
  router.post(
    '/apply/:token',
    requestProfileApplicationValidator,
    validateRequest,
  ...
  router.get('/p/_recovery-check', asyncHandler(accessController.showPortalRecoveryDiagnostics));
